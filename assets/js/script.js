...
if (body.classList.contains('speaker-page')) {
    ...
    showMoreBtn.addEventListener('click', function (e) {
        e.preventDefault();
        const activeImages = document.querySelectorAll('.gallery-item.active');
        for (let i = activeImages.length; i < activeImages.length + limit; i++) {
            const activeImages = document.querySelectorAll('.gallery-item.active');
            galleryItem[i].classList.add('active');
